...
public class OptionsSuper {
	...
	public String tdevfile = null;
	public String ttestfile = null;
	...
	public boolean usedep = false;
	public boolean usetpstack = false;
	...
	public boolean decodeProjective = true;
	...
	public void addOption(String args[], int i) {
			...
			if (args[i].equals("-train")) {
				...
				test = true;
				testfile = args[i+1]; i++;
			} else if (args[i].equals("-ttest")) {
				ttestfile = args[i+1]; i++;
			} else if (args[i].equals("-tdev")) {
				tdevfile = args[i+1]; i++;
